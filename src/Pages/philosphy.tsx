...
function PhilosophyPart(){
    ...
    return(
        <div className="relative border-b border-b-border-color bg-black p-2.5 flex flex-col items-center gap-1.5">
            <img src={purpleAura} alt="purple energy" className="absolute top-0 left-[-33px] w-[50%] h-full lg:h-27.75 z-10 "/>
            <img src={goldenAura} alt="golden energy" className="absolute top-0 right-[-33px] w-[50%] h-full lg:h-27.75"/>
...
function Footer(){
    return(
        <div className="bg-black relative flex lg:flex-row flex-col p-3 w-full gap-[15%]">
            <img src={purpleAura} alt="purple energy" className="absolute bottom-0 right-[-33px] w-[50%] h-full lg:h-27.75 z-10 "/>
            <img src={goldenAura} alt="golden energy" className="absolute bottom-0 left-[-33px] w-[50%] h-full lg:h-27.75 z-10"/>
            ...
            <div className="flex flex-col order-1 lg:order-2 z-10 items-center justify-self-center gap-1.5">
                ...
                <button className="uppercase flex  flex-row w-[183px] py-1.5 text-white text-[13px] self-center font-medium bg-linear-to-br from-20% from-primary-purple to-80% to-black items-center gap-2.5 justify-center border-2 p-1 rounded-[10px] border-border-color">
