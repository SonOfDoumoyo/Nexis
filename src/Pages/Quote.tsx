...
export default function QuoteSection() {
    ...
    return (
        <div className={`flex lg:flex-row md:flex-row flex-col gap-0 h-101.25 p-7.25 items-center lg:gap-72.5 text-white bg-black border-y-border-color relative justify-between`}>
            ...
            {!isMobile && (<p className={`z-100 text-[17px] font-medium text-subText`}>We create digital experiences that do more<br /> than look good they make people feel<br /> something and take action</p>)}
        </div>
    )
}