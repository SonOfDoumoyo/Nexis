...
export default function QuoteSection(){
    return(
        <div className="flex h-[305px] p-[29px] items-center gap-[290px] border-y-2 text-white bg-black border-y-border-color relative">
            ...
            <p className="font-bebas z-[100] text-[43px] font-normal uppercase">Good businesses exist.<br/> Great experiences <br /> make peole <span className="text-primary-purple">notice</span></p>
