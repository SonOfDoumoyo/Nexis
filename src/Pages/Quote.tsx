...
export default function QuoteSection() {
    return (
        <div className="flex lg:flex-row flex-col gap-0 h-101.25 p-7.25 items-center lg:gap-72.5 text-white bg-black border-y-border-color relative justify-between">
