...
import ProblemImg from "../assets/nexis_standalone_assets/before-photo.png"
import SolutionImg from  "../assets/nexis_standalone_assets/after-photo.png"
...
function Problem(){
    ...
    return(
        <div className="flex w-full lg:w-[50%] p-3.25 md:p-7.5 flex-col gap-6 h-full lg:p-10 border-r border-border-color bg-linear-to-tr from-40% from-black to-deep-purple">
